...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this dyndeploy.Add(mgr) to install this Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileDynDeploy{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by DynDeploy - change this for objects you create
...
var _ reconcile.Reconciler = &ReconcileDynDeploy{}

// ReconcileDynDeploy reconciles a DynDeploy object
type ReconcileDynDeploy struct {
	client.Client
...
func (r *ReconcileDynDeploy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the DynDeploy instance
